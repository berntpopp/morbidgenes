  ...
  data() {
        return {
          ...
          headers:[
            ...
            { text:"ClinVar", value:"ClinVarPathogenic" },
            { text:"OMIM Phenotype", value:"Phenotype_MIM" },
            { text:"HGMD", value:"HGMD_pathogenic" },
            { text:"PanelApp", value:"PanelApp" },
            { text:"SysNDD", value:"SysNDD" },
            { text:"MorbidScore", value:"mg_score" },
          ],
          search: '',
          totalRows: 1,
          absolute: true,
